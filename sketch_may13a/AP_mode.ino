	...
	<div class="plan">
		<div class="enabling-buttons-container">
			...
			<div class="switch-all-container">
				<button class="turn-on-button turn-all-button" onclick="changeAllOnClick(); " id = "turn-on-all-leds">Включить все</button>
				<button class="turn-off-button turn-all-button" onclick="changeAllOffClick();" id = "turn-off-all-leds">Выключить все</button>
			</div>
		</div>
